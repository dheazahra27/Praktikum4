...
class Latihan4 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Ambil username yang dititpkan dari Latihan3
        ...
        bottomNav.setOnItemSelectedListener { item ->
            when (item.itemId) {
                ...
                R.id.menu_profile -> {
                    // kirim username ke profileFragment lewat fungsu newInstance
    ...
    //tampilkan AlterDialog untuk konfirmasi laogout
    private fun tampilkanDialogLogout() {
        AlertDialog.Builder(this)
            ...
            .setPositiveButton("Ya") { _, _ ->
                ...
                // Bersihkan back stack: user tidak bisa ke Latihan4 lagi
